...
# setting directory
setwd("/Users/Kozodoi/Documents/HU Berlin/Applied Predictive Analytics/Final")
...
save(predictions,      file = "tmp2_predictions_raw_1.Rda")
save(errors,           file = "tmp2_errors_1.Rda")
save(grid,             file = "tmp2_parameters_1.Rda")
