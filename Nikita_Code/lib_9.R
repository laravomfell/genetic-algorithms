...
install.packages(c('beepr', 'randomForest', 'xgboost', 'data.table', 'Matrix', 'SparseM', 'doParallel'))
# libraries
library(beepr)
library(caret)
...
save(predictions,      file = "tmp2_predictions_raw_9.Rda")
save(errors,           file = "tmp2_errors_9.Rda")
save(grid,             file = "tmp2_parameters_9.Rda")
